	...
	public function get_list()
	{
		...
		if (!empty($orderids)) {
			...
			foreach ($list as &$row) {
				...
				$row['member'] = pdo_fetch('select openid,nickname,avatar from ' . tablename('ewei_shop_member').' where uniacid =:uniacid and openid=:openid',array(":uniacid"=>$_W['uniacid'],":openid"=>$row['openid']));
